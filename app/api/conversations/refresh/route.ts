...
export async function GET(req: NextRequest) {
  ...
  console.log(`https://graph.facebook.com/v19.0/${existingIntegration.page_id}/messages
    ?recipient={'id':'${body.conversation_id}'}
    &messaging_type=RESPONSE
    &message={'text':'${body.message}'}
    &access_token=${existingIntegration?.page_access_token}`);
  console.log(JSON.stringify(await message_response.json()));
